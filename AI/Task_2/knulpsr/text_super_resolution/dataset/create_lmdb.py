...
def create_800k():
    json_path = '<SYNTH_TEXT_ANNOTATION_PATH>'
    lmdb_output_path = '<LMDB_OUTPUT_ROOT>'
...
def create_ic():
    json_path = '<ICDAR_ANNOTATION_PATH>'
    lmdb_output_path_13train = '<ICDAR13_TRAIN_LMDB_ROOT>'
    lmdb_output_path_13test = '<ICDAR13_TEST_LMDB_ROOT>'
    lmdb_output_path_15train = '<ICDAR15_TRAIN_LMDB_ROOT>'
    lmdb_output_path_15test = '<ICDAR15_TEST_LMDB_ROOT>'
    ...
    for i in data:
        ...
        image_name = os.path.join('data/SRGAN/ic13', image_name.split('/')[-1])
...
def create_txt():
    ...
    image_labels = []
    image_paths = []
    lmdb_output_path = '<SVTP_LMDB_ROOT>'
...
def create_from_lmdb():
    root = '<LMDB_ROOT>/str/syn800k_HR2'
    out_path = '<LMDB_ROOT>/str/syn800k_HR_crop'
