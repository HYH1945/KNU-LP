...
def _get_chinese_alphabet():
    global _CHINESE_ALPHABET
    if _CHINESE_ALPHABET is not None:
        return _CHINESE_ALPHABET

    alphabet_path = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "..", "..", "al_chinese.txt")
    )
