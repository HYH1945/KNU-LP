...
def build_character_accuracy_histogram(ground_truth, predictions, bar_width=0.6, space_between_bars=1.5, figure_size=(20, 12), title_postfix = 'dataset'):
    """
...
def build_ocr_accuracy_histogram(ground_truth, predictions, title_postfix = 'dataset'):
    """
