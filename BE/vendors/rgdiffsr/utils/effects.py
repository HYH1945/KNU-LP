...
def mosaic(image, window_size=5, p=None, size=None):
    ...
    image.save(f'outputs/tmp/mosaic{window_size}.jpg')
...
def fuse(img_HR, img_lr, p=None, size=None):
    ...
    image.save('outputs/tmp/fuse.jpg')

    image = Image.fromarray(arr3)
    image.save('outputs/tmp/concat.jpg')

    img_HR.save('outputs/tmp/HR.jpg')
    img_lr.save('outputs/tmp/lr.jpg')


if __name__ == '__main__':
    tz = textzoom('data/textzoom/train1')
